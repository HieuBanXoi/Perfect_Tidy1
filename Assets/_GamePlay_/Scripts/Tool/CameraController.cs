...
public class CameraController : MonoBehaviour
{
    ...
    private void StartCameraDrag(Vector2 screenPosition)
    {
    ...
    private void DragCamera(Vector2 screenPosition)
    {
    ...
    private bool TryGetWorldPoint(Vector2 screenPosition, out Vector3 worldPosition)
    {
    ...
    private bool IsPointerOverGameplayObject(Vector2 screenPosition)
    {
