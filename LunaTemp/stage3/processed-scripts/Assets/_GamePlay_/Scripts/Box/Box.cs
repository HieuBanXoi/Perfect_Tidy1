...
public class Box : MonoBehaviour
{
    ...
    private bool RevealNextItem([Bridge.Ref] Vector3 targetPosition, Action onComplete = null, bool moveFromBox = false)
    {
        Item itemComponent = GetNextDynamicItem(out int itemIndex);
        if (itemComponent == null)
        {
    ...
    private void AddAvailableBoxSpawnPosition([Bridge.Ref] Vector3 targetPosition)
    {
